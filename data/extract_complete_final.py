...
for url, slug, titulo_default in urls:
    ...
    # Duración y Sede - buscar directamente en text-editor widgets
    duracion = ""
    sede = ""
    ...
    # Extraer secciones por labels de lista
    descripcion = ""
    objetivo = ""
    ...
    if main_content:
        ...
        while i < len(widgets):
            ...
            # Si es un widget con h2 label y contenido largo en el mismo widget (p o text-editor)
            if h2:
