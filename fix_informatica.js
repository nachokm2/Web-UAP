...
(async () => {
  ...
  try {
    const url = 'https://uap.edu.py/ingenieria-informatica/';
    const slug = 'ingenieria-en-informatica';
    console.log('Procesando:', slug, url);
    ...
    const filePath = path.join(dataDir, `carrera_${slug}.json`);
    let data = {};
